    ...
    <AnnotationProvider>
      <div className="flex min-h-screen relative">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="floating-orb w-96 h-96 bg-gradient-to-br from-orange-500/15 to-amber-500/15 -top-48 -right-48 animate-float"></div>
          ...
          <div className="floating-orb w-64 h-64 bg-gradient-to-br from-purple-500/8 to-pink-500/8 top-1/4 left-1/3 animate-float" style={{ animationDelay: '1s' }}></div>
        </div>
