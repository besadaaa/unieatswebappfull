...
export function CafeteriaPageHeader({ title, subtitle }: PageHeaderProps) {
  ...
  const fetchNotifications = async () => {
    try {
      // Mock notifications for cafeteria - in a real app, you'd fetch from your notifications table
      const mockNotifications: Notification[] = [
        {
          id: '1',
          title: 'New Order Received',
          message: 'Order #1234 has been placed and requires preparation',
          type: 'info',
        ...
        },
        {
          ...
          message: 'Chicken Burger ingredients are running low',
          type: 'warning',
        ...
        },
        {
          ...
          message: 'Payment for order #1230 has been processed successfully',
          type: 'success',
      ...
      <div className="flex items-center gap-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80 glass-effect border-white/20">
            ...
            <DropdownMenuSeparator className="bg-white/20" />
            <DropdownMenuItem
              onClick={() => router.push('/cafeteria/support')}
